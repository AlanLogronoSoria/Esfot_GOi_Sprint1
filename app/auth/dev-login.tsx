...
import { MockSupabaseAuth, MockExpressAuth } from '@/core/dev/mock-services';
...
export default function DevLoginScreen() {
  ...
  const handleDevLogin = async (role: 'estudiante' | 'docente' | 'admin') => {
    ...
    try {
      const result = await MockSupabaseAuth.signIn(creds.email, creds.password);
      setSession(result.user, result.token);

      try {
        const expressResult = await MockExpressAuth.loginEstudiante(creds.email, creds.password);
    ...
    <ScrollView contentContainerStyle={styles.scroll}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Selecciona un perfil para ingresar sin necesidad de backend. Los datos son simulados.
        </Text>
